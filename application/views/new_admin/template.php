    ...
    <div class="container-scroller">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Hi, <span class="text-black fw-bold"><?= $this->session->userdata('nama');?></span></h1>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <a class="dropdown-item" href="<?= site_url('welcome/logout') ?>"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item nav-category">Acara dan Penugasan</li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-acara" aria-expanded="false" aria-controls="ui-acara">
                            <i class="menu-icon mdi mdi-floor-plan"></i>
                            <span class="menu-title">Acara</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-acara">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?= site_url('admin/acara/create') ?>">Buat</a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?= site_url('admin/acara/list_acara') ?>">Daftar Acara</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- <li class="nav-item nav-category">Master Data Tugas</li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="#">Master Tugas</a></li>
                            </ul>
                        </div>
                    </li> -->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="user">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="<?= site_url('admin/user/list_user') ?>">Daftar User</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
